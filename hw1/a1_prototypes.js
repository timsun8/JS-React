function runA1() {
    ...
    Rectangle.prototype.describe = function(){ 
        const based = Shape.prototype.describe.call(this);
        return `${based} Rectangle ${this.width}*${this.height}`
     };
    ...
    Square.prototype.describe = function(){ 
        const based = Rectangle.prototype.describe.call(this);
        return `${based} Square side=${this.width}`;
     };
